...
var sideBar = function sideBar(data) {
  ...
  document.querySelector("#wind").innerHTML = "".concat(current.wind.speed, "Kmph");
  document.querySelector("#humidity").innerHTML = "".concat(all.current.humidity, "%");
  document.querySelector("#pressure").innerHTML = "".concat(all.current.pressure, "hPa");
  document.querySelector("#clouds").innerHTML = "".concat(current.clouds.all);
  var sunrise = new Date(all.current.sunrise * 1000).toLocaleString().split(",")[1];
  var sunset = new Date(all.current.sunset * 1000).toLocaleString().split(",")[1];
  document.querySelector("#sunrise").innerHTML = "".concat(sunrise);
...
var getWeatherData = function getWeatherData(lat, _long) {
  return new Promise(function (resolve, reject) {
    var url = "https://api.openweathermap.org/data/2.5/weather?lat=".concat(lat, "&lon=").concat(_long, "&appid=ffe8f234e7d1e07de86b9ddf5e70658b&units=metric");
...
var getForeCast = function getForeCast(lat, _long2) {
  return new Promise(function (resolve, reject) {
    var url = "https://api.openweathermap.org/data/2.5/forecast/hourly??lat=".concat(lat, "&lon=").concat(_long2, "&appid=ffe8f234e7d1e07de86b9ddf5e70658b&units=metric");
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(url).then(function (res) {
      resolve(res.data);
    })["catch"](function (err) {
      reject(err);
...
var singleCallAPI = function singleCallAPI(lat, _long3) {
  return new Promise(function (resolve, reject) {
    var url = "https://api.openweathermap.org/data/2.5/onecall?lat=".concat(lat, "&lon=").concat(_long3, "&appid=ffe8f234e7d1e07de86b9ddf5e70658b&units=metric");
    axios__WEBPACK_IMPORTED_MODULE_0___default().get(url).then(function (res) {
      resolve(res.data);
    })["catch"](function (err) {
      reject(err);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _index_sass__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.sass */ "./src/styles/index.sass");
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _scripts_request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./scripts/request */ "./src/scripts/request.js");
/* harmony import */ var _scripts_renderer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts/renderer */ "./src/scripts/renderer.js");
...
var loaderTitle = document.querySelector(".loader > .loader-content-tile");
var loaderSpinner = document.querySelector(".loader > .bars-3");
var main = document.querySelector("main");
var aside = document.querySelector("aside");
var lat, lng, weatherData, mainImageData;
weatherData = {
  current: null,
  total: null
};
...
/******/ })()
;
//# sourceMappingURL=output.bundle.js.map